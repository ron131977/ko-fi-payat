...
const Privacy = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'Buyonline Movies™ - Digital Entertainment@ $1.00 USD',
  ...
  return (
    <div>
       <Head>
        <title>Buyonline Movies™ | Privacy Policy</title>
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="text-gray-500 mb-6">
      Buyonline Movies™ may collect information from its users in three different ways: directly from the user, from traffic references of hostingservers and from cookies.
      </p>
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer2022@gmail.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of Buyonline Movies™  free from any and all liability.This site (Buyonline Movies™ ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer2022@gmail.com.com">contact us</a>.
      </p>
    </div>

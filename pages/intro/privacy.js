...
const Privacy = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://digitalbaymediahub.vercel.app/#webpage',
        url: 'https://digitalbaymediahub.vercel.app/',
        name: 'Movie',
        ...
        mainEntity: [
          {
            '@type': 'Article',
            '@id': 'https://digitalbaymediahub.vercel.app/',
            url: 'https://digitalbaymediahub.vercel.app/',
            headline: 'Movie',
            datePublished: '2024-01-13T13:00:00+00:00',
            dateModified: '2024-01-13T13:13:00+00:00',
  ...
  return (
    <div>
       <Head>
        <title>DigitalBay Media Hub™ | Privacy Policy</title>
        ...
        />
          ...
          <link rel='canonical' href='https://digitalbaymediahub.vercel.app/intro/privacy' />
          <meta property='og:locale' content='en_US' />
          <meta property='og:type' content='website' />
          <meta
            property='og:title'
            content='DigitalBay Media Hub™ '
          />
          <meta
            property='og:description'
            content='Explore the World of Digital Entertainment @ $1.00 USD – Books, Movies, Music, and More!'
          />
          <meta property='og:url' content='https://digitalbaymediahub.vercel.app/intro/privacy/' />
          <meta
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">DigitalBay Media Hub™ </p>
      <p className="text-gray-500 mb-6">
      DigitalBay Media Hub™ International(DigitalBay Media Hub™) is committed to protecting your privacy. This Privacy Policy applies only to the Web Sites and applications published by DigitalBay Media Hub™ International.
      </p>
      <p className="font-bold mb-2">Note: Use of Information</p>
      <p className="text-gray-500 mb-6">
      Information that we collect  </p>
      <p className="text-gray-500 mb-6">
      DigitalBay Media Hub™ may collect information from its users in three different ways: directly from the user, from traffic references of hostingservers and from cookies.
      </p>
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer2022@gmail.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of DigitalBay Media Hub™  free from any and all liability.This site (DigitalBay Media Hub™ ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer2022@gmail.com.com">contact us</a>.
      </p>
    </div>

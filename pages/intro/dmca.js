...
const dmca = () => {
  ...
  return (
    <div>
      <Head>
        <title>DigitalBay EntertainmentHub™ | DMCA</title>
        <link
          rel='sitemap'
        ...
        <link rel='canonical' href='https:/buyonlinemovies.vercel.app/intro/tearms' />
        <meta property='og:locale' content='en_US' />
        <meta property='og:type' content='website' />
        <meta property='og:title' content='DigitalBay EntertainmentHub™ ' />
        <meta
          property='og:description'
          content='Explore the World of Digital Entertainment @ $1.00 USD – Books, Movies, Music, and More!'
        />
        <meta property='og:url' content='https:/buyonlinemovies.vercel.app/intro/tearms/' />
        <meta property='og:site_name' content='DigitalBay EntertainmentHub™ ' />
        <meta
          property='og:image'
        ...
        <meta name='application-name' content='DigitalBay EntertainmentHub™ ' />
        <meta
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <p style={{ color: '#666', marginBottom: '24px' }}>
                ...
                their respective owners. DigitalBay EntertainmentHub complies with the federal
                ...
                DigitalBay EntertainmentHub website that is claimed to be infringing. In such
              ...
              <p style={{ color: '#666', marginBottom: '24px' }}>
                ...
                designed to align with DigitalBay EntertainmentHub's responsibilities under the
              ...
              >
                <li>
                  To submit a notice of infringing material on DigitalBay EntertainmentHub, kindly

...
export default function movies({ moviesData }) {
    ...
    "@graph": [
      {
        ...
        name: "Buyonline Movies™ – Movies Section.",
  ...
  const soap2daySchema = JSON.stringify({
    ...
    "@graph": [
      ...
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "Buyonline Movies™ – Movies Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https:/buyonlinemovies.vercel.app/movies#breadcrumb",
  ...
  return (
    <>
      <Head>
        <title> Buyonline Movies™ – Movies Section.</title>
        ...
        <meta
          property="og:title"
          content=" Buyonline Movies™ – Movies Section. "
        />
        <meta
          property="og:url"
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Buyonline Movies™ Movies Section.</h1>
        <a

...
const [isPopupVisible, setIsPopupVisible] = useState(false);
    ...
    "@graph": [
      {
        ...
        name: "DigitalBay EntertainmentHub™ – Adult Section.",
  ...
  const soap2daySchema = JSON.stringify({
    ...
    "@graph": [
      ...
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "DigitalBay EntertainmentHub™ – Adult Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https:/buyonlinemovies.vercel.app/adult#breadcrumb",
  ...
  return (
    <>
      <Head>
        <title> DigitalBay EntertainmentHub™ – Adult Section.</title>
        ...
        <meta
          property="og:title"
          content=" DigitalBay EntertainmentHub™ – Adult Section. "
        />
        <meta
          property="og:url"

...
export default function tvshow({ tvshowData }) {
    ...
    "@graph": [
      {
        ...
        name: "Buyonline Movies™ – Tv Show Section.",
        url: "https:/buyonlinemovies.vercel.app/",
      },
      {
        "@type": "WebSite",
        "@id": "https:/buyonlinemovies.vercel.app/tvshow#website",
        url: "https:/buyonlinemovies.vercel.app/tvshow",
        name: "Buyonline Movies™ – Tv Show Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https:/buyonlinemovies.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https:/buyonlinemovies.vercel.app/tvshow#webpage",
        url: "https:/buyonlinemovies.vercel.app/tvshow",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https:/buyonlinemovies.vercel.app/tvshow",
            url: "https:/buyonlinemovies.vercel.app/tvshow",
            headline: "Buyonline Movies™",
            datePublished: "2024-01-13T13:00:00+00:00",
            dateModified: "2024-01-13T13:13:00+00:00",
            publisher: {
              "@type": "Organization",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https:/buyonlinemovies.vercel.app/tvshow#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https:/buyonlinemovies.vercel.app/tvshow"],
          },
        ],
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "Buyonline Movies™ – Tv Show Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https:/buyonlinemovies.vercel.app/tvshow#breadcrumb",
        itemListElement: [
          {
            ...
            position: 1,
            name: "tvshow",
            item: "https:/buyonlinemovies.vercel.app/tvshow",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> Buyonline Movies™ – Tv Show Section.</title>
       ...
       <meta
          ...
          content="buyonline movies, movie, movies, video, videos, dvd, dvds, hd-dvd, blu-ray, buy movies, classic movies, comedy movies, horror movies, musicals, action movies, western movies, movie collectors, hard to find movies, movie posters"
        />
         <meta name="keywords" content="buyonline movies, movie, movies, video, videos, dvd, dvds, hd-dvd, blu-ray, buy movies, classic movies, comedy movies, horror movies, musicals, action movies, western movies, movie collectors, hard to find movies, movie posters" />
        <meta
        ...
        <meta
          ...
          content="Explore the World of Digital Entertainment @ $1.00 USD – Books, Movies, Music, and More!"
        />
        <link rel="canonical" href="https:/buyonlinemovies.vercel.app/tvshow" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" Buyonline Movies™ – Tv Show Section. "
        />
        <meta
          property="og:url"
          content="https:/buyonlinemovies.vercel.app/tvshow"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Buyonline Movies™ Tv Show Section.</h1>
        <a

...
export default function tvshow({ tvshowData }) {
    ...
    "@graph": [
      {
        ...
        name: "DigitalBay EntertainmentHub™ – Tv Show Section.",
  ...
  const soap2daySchema = JSON.stringify({
    ...
    "@graph": [
      ...
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "DigitalBay EntertainmentHub™ – Tv Show Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https:/buyonlinemovies.vercel.app/tvshow#breadcrumb",
  ...
  return (
    <>
      <Head>
        <title> DigitalBay EntertainmentHub™ – Tv Show Section.</title>
       ...
       <meta
        ...
        <meta
          property="og:title"
          content=" DigitalBay EntertainmentHub™ – Tv Show Section. "
        />
        <meta
          property="og:url"
          ...
          >
            ...
            >
              ...
              >
                ...
                <br />
                Movies & TV Series by connecting to 
                <a
              href="https://t.me/ondigitalbay"
              target="_blank"
              rel="noopener noreferrer"
